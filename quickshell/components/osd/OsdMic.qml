// OsdMic.qml — Microphone OSD, segmented bar style
import QtQuick
import qs.core as C
    ...
    Rectangle {
        ...
        Column {
            ...
            Row {
                ...
                Text {
                    text: C.Audio.micMuted ? "Mic: Muted" : "Mic: " + C.Audio.micLevel + "%"
                    font.family: C.Style.fontMono
                    font.pixelSize: C.Style.fs.md
                    color: C.Audio.micMuted ? C.Colors.red : C.Colors.text
                    anchors.verticalCenter: parent.verticalCenter
                }
            }
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        height: 10
                        color: (index < Math.round(C.Audio.micLevel / 5))
                            ? (C.Audio.micMuted ? C.Colors.red : C.Colors.text)
                            : C.Colors.muted
